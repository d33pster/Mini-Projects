...
# initial values of some variable
var = ""
A = 0
operator = ""

# defining function for button 1
def button_1_is_Clicked():
    global var
    var = var + "1"
    the_data.set(var)

# defining function for button 2
def button_2_is_Clicked():
    global var
    var = var + "2"
    the_data.set(var)

# defining function for button 3
...
# defining function for Button 4  
